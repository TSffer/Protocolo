...
{
    string Bloques = funcion(1024,56,15,7,10);
    string Num;
    for(int i = 0;i<Bloques.size(); i+= 64)
    {
        string aux(Bloques,i,64);
    ...
    cout<<"NUMERO DE BITS : "<<Num.size()<<endl;
    vector<bool> aa = ConvertirString_a_Vector(Num);
    ZZ aleatorio = Convertir_a_Decimal(aa);
    cout<<aleatorio<<endl;
    return ZZ(0);
}
